...
* ***To cleane, prepare the dataset*** As the file is in XML format and cannot be straightly converted to well-structured RDD or dataframe, we parse the raw RDD manually by using a *lambda* function. 
